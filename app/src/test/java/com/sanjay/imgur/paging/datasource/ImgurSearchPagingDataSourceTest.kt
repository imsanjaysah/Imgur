...
import com.sanjay.imgur.RxImmediateSchedulerRule
...
class ImgurSearchPagingDataSourceTest {
    private var pagingDataSource: ImgurSearchPagingDataSource? = null
    ...
    @Mock
    lateinit var loadCallback: PageKeyedDataSource.LoadCallback<Int, ImgurImage>

    private var loadInitialParams = PageKeyedDataSource.LoadInitialParams<Int>(20, false)

    @Mock
    lateinit var loadInitialCallback: PageKeyedDataSource.LoadInitialCallback<Int, ImgurImage>
    ...
    fun setUp() {
        ...
        pagingDataSource = ImgurSearchPagingDataSource(repository)

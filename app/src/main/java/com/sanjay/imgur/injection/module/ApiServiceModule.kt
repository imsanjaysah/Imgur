...
import com.sanjay.imgur.data.api.HeaderInterceptor
import com.sanjay.imgur.data.api.ImgurService
import com.sanjay.imgur.extensions.isConnected
...
open class ApiServiceModule {
    ...
    internal fun provideHttpClient(
        ...
        httpInterceptor: HttpLoggingInterceptor, app: ImgurApplication
    ): OkHttpClient {
    ...
    @Provides
    @Singleton
    open fun provideService(retrofit: Retrofit): ImgurService {
